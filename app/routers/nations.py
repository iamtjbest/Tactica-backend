...
WC_NATIONS: list[dict] = [
    ...
    {"id":  5, "name": "Uruguay",     "bsd_names": ["Uruguay"],                    "conf": "CONMEBOL", "code": "UY"},
    {"id":  6, "name": "Venezuela",   "bsd_names": ["Venezuela"],                  "conf": "CONMEBOL", "code": "VE"},
    {"id":  7, "name": "France",      "bsd_names": ["France"],                     "conf": "UEFA",     "code": "FR"},
    {"id":  8, "name": "Spain",       "bsd_names": ["Spain","España"],             "conf": "UEFA",     "code": "ES"},
    {"id":  9, "name": "Germany",     "bsd_names": ["Germany","Deutschland"],      "conf": "UEFA",     "code": "DE"},
    {"id": 10, "name": "England",     "bsd_names": ["England"],                    "conf": "UEFA",     "code": "ENG"},
    {"id": 11, "name": "Portugal",    "bsd_names": ["Portugal"],                   "conf": "UEFA",     "code": "PT"},
    {"id": 12, "name": "Netherlands", "bsd_names": ["Netherlands","Holland"],      "conf": "UEFA",     "code": "NL"},
    {"id": 13, "name": "Belgium",     "bsd_names": ["Belgium","Belgique"],         "conf": "UEFA",     "code": "BE"},
    {"id": 14, "name": "Italy",       "bsd_names": ["Italy","Italia"],             "conf": "UEFA",     "code": "IT"},
    {"id": 15, "name": "Switzerland", "bsd_names": ["Switzerland","Schweiz"],      "conf": "UEFA",     "code": "CH"},
    {"id": 16, "name": "Denmark",     "bsd_names": ["Denmark","Danmark"],          "conf": "UEFA",     "code": "DK"},
    {"id": 17, "name": "Croatia",     "bsd_names": ["Croatia","Hrvatska"],         "conf": "UEFA",     "code": "HR"},
    {"id": 18, "name": "Austria",     "bsd_names": ["Austria","Österreich"],       "conf": "UEFA",     "code": "AT"},
    {"id": 19, "name": "Serbia",      "bsd_names": ["Serbia"],                     "conf": "UEFA",     "code": "RS"},
    {"id": 20, "name": "Scotland",    "bsd_names": ["Scotland"],                   "conf": "UEFA",     "code": "SCO"},
    {"id": 21, "name": "Poland",      "bsd_names": ["Poland","Polska"],            "conf": "UEFA",     "code": "PL"},
    {"id": 22, "name": "Turkey",      "bsd_names": ["Turkey","Türkiye"],           "conf": "UEFA",     "code": "TR"},
    {"id": 23, "name": "Morocco",     "bsd_names": ["Morocco","Maroc"],            "conf": "CAF",      "code": "MA"},
    {"id": 24, "name": "Senegal",     "bsd_names": ["Senegal"],                    "conf": "CAF",      "code": "SN"},
    {"id": 25, "name": "Nigeria",     "bsd_names": ["Nigeria"],                    "conf": "CAF",      "code": "NG"},
    {"id": 26, "name": "Cameroon",    "bsd_names": ["Cameroon","Cameroun"],        "conf": "CAF",      "code": "CM"},
    {"id": 27, "name": "Egypt",       "bsd_names": ["Egypt"],                      "conf": "CAF",      "code": "EG"},
    {"id": 28, "name": "South Africa","bsd_names": ["South Africa","Bafana Bafana"],"conf": "CAF",     "code": "ZA"},
    {"id": 29, "name": "Mali",        "bsd_names": ["Mali"],                       "conf": "CAF",      "code": "ML"},
    {"id": 30, "name": "DR Congo",    "bsd_names": ["DR Congo","Congo DR","DRC"],  "conf": "CAF",      "code": "CD"},
    {"id": 31, "name": "Tunisia",     "bsd_names": ["Tunisia","Tunisie"],          "conf": "CAF",      "code": "TN"},
    {"id": 32, "name": "Japan",       "bsd_names": ["Japan","Japon"],              "conf": "AFC",      "code": "JP"},
    {"id": 33, "name": "South Korea", "bsd_names": ["South Korea","Korea Republic"],"conf": "AFC",     "code": "KR"},
    {"id": 34, "name": "Iran",        "bsd_names": ["Iran","IR Iran"],             "conf": "AFC",      "code": "IR"},
    {"id": 35, "name": "Australia",   "bsd_names": ["Australia","Socceroos"],      "conf": "AFC",      "code": "AU"},
    {"id": 36, "name": "Saudi Arabia","bsd_names": ["Saudi Arabia"],               "conf": "AFC",      "code": "SA"},
    {"id": 37, "name": "Uzbekistan",  "bsd_names": ["Uzbekistan"],                 "conf": "AFC",      "code": "UZ"},
    {"id": 38, "name": "Jordan",      "bsd_names": ["Jordan"],                     "conf": "AFC",      "code": "JO"},
    {"id": 39, "name": "Iraq",        "bsd_names": ["Iraq"],                       "conf": "AFC",      "code": "IQ"},
    {"id": 40, "name": "USA",         "bsd_names": ["USA","United States"],        "conf": "CONCACAF", "code": "US"},
    {"id": 41, "name": "Mexico",      "bsd_names": ["Mexico","México"],            "conf": "CONCACAF", "code": "MX"},
    {"id": 42, "name": "Canada",      "bsd_names": ["Canada"],                     "conf": "CONCACAF", "code": "CA"},
    {"id": 43, "name": "Costa Rica",  "bsd_names": ["Costa Rica"],                 "conf": "CONCACAF", "code": "CR"},
    {"id": 44, "name": "Honduras",    "bsd_names": ["Honduras"],                   "conf": "CONCACAF", "code": "HN"},
    {"id": 45, "name": "Panama",      "bsd_names": ["Panama","Panamá"],            "conf": "CONCACAF", "code": "PA"},
    {"id": 46, "name": "New Zealand", "bsd_names": ["New Zealand","All Whites"],   "conf": "OFC",      "code": "NZ"},
    {"id": 47, "name": "Bolivia",     "bsd_names": ["Bolivia"],                    "conf": "CONMEBOL", "code": "BO"},
    {"id": 48, "name": "Paraguay",    "bsd_names": ["Paraguay"],                   "conf": "CONMEBOL", "code": "PY"},
]
